...
import {  demoSections } from "./formsections"; 
//The above line sections is the name exported by the module demoSections is the local name you will use inside the importing file
